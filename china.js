const ans11="QIN SHI HUANG"
const ans12="21196 km"
const ans13="10 million"
const ans14="nothern china"
const ans15="steel"
...
class China{
    constructor(){
        ...
        this.button1.mousePressed(()=>{
          if(authenticate(ans11,this.input1.value())){
            this.input1.hide()
            this.button1.hide()
        ...
        this.button2.mousePressed(()=>{
          if(authenticate(ans12,this.input2.value())){
           this.input2.hide()
            this.button2.hide()
        ...
        this.button3.mousePressed(()=>{
          if(authenticate(ans13,this.input3.value())){
            this.input3.hide()
            this.button3.hide()
        ...
        this.button4.mousePressed(()=>{
          if(authenticate(ans14,this.input4.value())){
            this.input4.hide()
            this.button4.hide()
        ...
        this.button5.mousePressed(()=>{
          if(authenticate(ans15,this.input5.value())){
            this.input5.hide()
            this.button5.hide()
