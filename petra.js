const ans31="QIN SHI HUANG"
const ans32="21196 km"
const ans33="10 million"
const ans34="nothern china"
const ans35="steel"
...
class China{
    constructor(){
        ...
        this.button1.mousePressed(()=>{
          if(authenticate(ans31,this.input1.value())){
            this.input1.hide()
            this.button1.hide()
        ...
        this.button2.mousePressed(()=>{
          if(authenticate(ans32,this.input2.value())){
           this.input2.hide()
            this.button2.hide()
